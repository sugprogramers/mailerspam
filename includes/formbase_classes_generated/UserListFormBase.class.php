...
//		protected function Form_Validate() {}
		...
		protected function Form_Create() {
			...
			$this->dtgUsers->MetaAddColumn('Mac');
			$this->dtgUsers->MetaAddColumn('TokenMac');
			$this->dtgUsers->MetaAddColumn('StatusTokenMac');
			$this->dtgUsers->MetaAddColumn('WalletAddress');
			$this->dtgUsers->MetaAddColumn('NumberMasterNode');
		}
	}
?>
