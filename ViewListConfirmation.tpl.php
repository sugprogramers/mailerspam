...
<div class="page">
    <div class="page-header">
        <h1 class="page-title"> <i class="far fa-envelope"></i> Confirmations</h1>
    </div>
    <div class="page-content container-fluid">
        <!-- Panel Table Add Row -->
        <div class="panel">
            <header class="panel-heading">
                <h3 class="panel-title">View Confirmations</h3>
            </header>
            <div class="panel-body" style="min-height:260px;">
                ...
                <div class="row">
                    ...
                    <div id="Found1" style="display:none;" class="vertical-align text-center" >
                        <div class="page-content vertical-align-middle">
                            <header>
                                <div class="animation-slide-top" style="font-size: 65px;margin-right:0px;padding: 0px;color:#ccc;"><i class="far fa-envelope"></i></div>
                                <p   style="font-size: 22px;color: #848484;">No registered confirmations were found.</p>
                            </header>
                            <p class="error-advise animation-slide-left" style="font-size: 12px;">You must register a new confirmation.</p>
                            <br>
                        </div> 
                    </div>
                    ...
                    <div id="Found2" style="display:none;"  class="example-wrap">
                        ...
                        <div class="example">
                            <div class="table-responsive">
                                <?php $this->dtgConfirmations->Render(); ?>
                ...
                <div class="site-action" > <?php $this->btnNewConfirmation->Render(); ?></div>
...
<?php $this->dlgDialogEditConfirmation->Render(); ?>
