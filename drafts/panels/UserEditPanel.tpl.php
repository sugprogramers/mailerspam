...
?>
	<div id="formControls">
		...
		<?php $_CONTROL->txtMac->RenderWithName(); ?>

		<?php $_CONTROL->txtTokenMac->RenderWithName(); ?>

		<?php $_CONTROL->txtStatusTokenMac->RenderWithName(); ?>

		<?php $_CONTROL->txtWalletAddress->RenderWithName(); ?>

		<?php $_CONTROL->txtNumberMasterNode->RenderWithName(); ?>
