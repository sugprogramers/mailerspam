<?php
	...
	class UserEditPanel extends QPanel {
		...
		public function __construct($objParentObject, $strClosePanelMethod, $intIdUser = null, $strControlId = null) {
			...
			$this->txtMac = $this->mctUser->txtMac_Create();
			$this->txtTokenMac = $this->mctUser->txtTokenMac_Create();
			$this->txtStatusTokenMac = $this->mctUser->txtStatusTokenMac_Create();
			$this->txtWalletAddress = $this->mctUser->txtWalletAddress_Create();
			$this->txtNumberMasterNode = $this->mctUser->txtNumberMasterNode_Create();
